      ...
      <div>
        ...
        <div className="container">
          ...
          <img
            ...
            src="client/styles/images/hummingbird.jpg"
            alt="Hummingbird"
          />
          <img
            className="item frame"
            src="client/styles/images/wedding.jpg"
            alt="Bride & Groom at a wedding"
          />

          <img
            className="small item frame"
            src="client/styles/images/baby.jpg"
            alt="Newborn baby"
          />
          <img
            className="small item frame"
            src="client/styles/images/rocky-mountains.jpg"
            alt="Rocky Mountains"
          />
          ...
          <ul className="small item">
            ...
            <li>
              <button className="btn" onClick={() => this.toggleModal()}>Book a session</button>
            </li>
          ...
          <div className="item about-me">
            ...
            <img
              ...
              src="client/styles/images/moriah.jpg"
              alt="Moriah Maddux Profile"
            />
            <p>
          ...
          <img
            className="item frame"
            src="client/styles/images/children.jpg"
